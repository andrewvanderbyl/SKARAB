function [Serial_Data, Sync, Dvalid] = Parallel_Serial_4input_sync_dv(Input_0,Input_1,Input_2,Input_3, Sync_in, dvalid_in)
...
elseif (strcmp(Input_class,'struct'))
    ...
    Sync = zeros(num_inputs*length(Input_0),1);
    ...
    for i=1:length(Input_0.signals.values)
       ...
       Sync(k+1,1) = Sync_in.signals.values(i,1);
