...
class coarse_delay:
    ...
    def reorder(self, arm_mode, trig_mode, valid_mode, plot_count_max, disp_length, delay, read_length, sync_sel):
        ...
        print "Grabbing snap_reordb"
        reord_int = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_Reorder_cntrl_snap_reord_int_ss.read(arm=False, man_trig=trig_mode,
                                                                                        man_valid=valid_mode)['data']
    ...
    # Test Coarse delay Pol0 only
    # ---------------------------
    def pol0_cd_test(self, arm_mode, trig_mode, valid_mode, delay, read_length,sync_sel):
        self.skarab_info()
        ...
        self.f.snapshots.cd_in_ss.arm(man_trig=trig_mode, man_valid=valid_mode)

        self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reorda_ss.arm(man_trig=trig_mode, man_valid=valid_mode)
        self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reordb_ss.arm(man_trig=trig_mode, man_valid=valid_mode)

        self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_din_ss.arm(man_trig=trig_mode, man_valid=valid_mode)
        self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_dout_ss.arm(man_trig=trig_mode, man_valid=valid_mode)

        self.f.snapshots.hmc_out_ss.arm(man_trig=trig_mode, man_valid=valid_mode)

        self.f.snapshots.wb_prog_delay_bs_in_ss.arm(man_trig=trig_mode, man_valid=valid_mode)

        self.f.snapshots.delay_tl_out_ss.arm(man_trig=trig_mode, man_valid=valid_mode)
		
        self.f.snapshots.cd_out_ss.arm(man_trig=trig_mode, man_valid=valid_mode)
        ...
        print "Grabbing cd in"
        cd_in = self.f.snapshots.cd_in_ss.read(arm=False)['data']

        print "Grabbing reorda"
        reorda = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reorda_ss.read(arm=False)['data']
        print "Grabbing reordb"
        reordb = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reordb_ss.read(arm=False)['data']

        print "Grabbing reord_datain"
        reord_datain = \
            self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_din_ss.read(arm=False)['data']

        print "Grabbing reord_dataout"
        reord_dataout = \
            self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_dout_ss.read(arm=False)['data']

        print "Grabbing hmc_out"
        hmc_out = self.f.snapshots.hmc_out_ss.read(arm=False)['data']

        print "Grabbing SS bs_in"
        bs_in0 = self.f.snapshots.wb_prog_delay_bs_in_ss.read(arm=False)['data']

        print "Grabbing SS delay_tl_out"
        delay_tl_out = self.f.snapshots.delay_tl_out_ss.read(arm=False)['data']

        print "Grabbing cd_out"
        cd_out = self.f.snapshots.cd_out_ss.read(arm=False)['data']
        ...
        hmc_dataout_0 = hmc_out['d00']
        hmc_dataout_1 = hmc_out['d01']
        hmc_dataout_2 = hmc_out['d02']
        hmc_dataout_3 = hmc_out['d03']
        hmc_dataout_4 = hmc_out['d04']
        hmc_dataout_5 = hmc_out['d05']
        hmc_dataout_6 = hmc_out['d06']
        hmc_dataout_7 = hmc_out['d07']
        hmc_dv = hmc_out['dvalid']
        hmc_sync = hmc_out['sync']
        ...
        delay_tl_out_0 = delay_tl_out['d00']
        delay_tl_out_1 = delay_tl_out['d01']
        delay_tl_out_2 = delay_tl_out['d02']
        delay_tl_out_3 = delay_tl_out['d03']
        delay_tl_out_4 = delay_tl_out['d04']
        delay_tl_out_5 = delay_tl_out['d05']
        delay_tl_out_6 = delay_tl_out['d06']
        delay_tl_out_7 = delay_tl_out['d07']
        delay_tl_dv = delay_tl_out['dvalid']
        delay_tl_sync = delay_tl_out['sync']
        ...
        print ''
        print 'Pack the cd input correctly'
        print '---------------------------'

        cd_input = []

        for x in range(0, len(cd_in_0)):
            cd_input.extend(
                [cd_in_0[x], cd_in_1[x], cd_in_2[x], cd_in_3[x], cd_in_4[x],
                 cd_in_5[x], cd_in_6[x], cd_in_7[x]])

        print ''
        print 'Pack the reorder input correctly'
        print '--------------------------------'
        reord_input = []

        for x in range(0, len(reord_datain_0)):
            reord_input.extend([reord_datain_0[x], reord_datain_1[x], reord_datain_2[x], reord_datain_3[x], reord_datain_4[x],
                          reord_datain_5[x], reord_datain_6[x], reord_datain_7[x]])
        ...
        for x in range(0, len(reord_dataout_0)):
            reord_output.extend(
                [reord_dataout_0[x], reord_dataout_1[x], reord_dataout_2[x], reord_dataout_3[x], reord_dataout_4[x],
                 reord_dataout_5[x],
                 reord_dataout_6[x], reord_dataout_7[x]])
        ...
        for x in range(0, len(hmc_dataout_0)):
            hmc_output.extend(
                [hmc_dataout_0[x], hmc_dataout_1[x], hmc_dataout_2[x], hmc_dataout_3[x], hmc_dataout_4[x],
                 hmc_dataout_5[x], hmc_dataout_6[x], hmc_dataout_7[x]])


        print ''
        print 'Pack the delay_tl_out output'
        print '-----------------------'
        delay_tl = []

        for x in range(0, len(delay_tl_out_0)):
            delay_tl.extend(
                [delay_tl_out_0[x], delay_tl_out_1[x], delay_tl_out_2[x], delay_tl_out_3[x], delay_tl_out_4[x],
                 delay_tl_out_5[x], delay_tl_out_6[x], delay_tl_out_7[x]])

        print ''
        print 'Pack the bs_in output'
        print '-----------------------'
        bs_in = []

        for x in range(0, len(bs_in_0)):
            bs_in.extend(
                [bs_in_0[x], bs_in_1[x], bs_in_2[x], bs_in_3[x], bs_in_4[x],
                 bs_in_5[x], bs_in_6[x], bs_in_7[x]])
        ...
        for x in range(0, len(cd_out_0)):
            cd_output.extend(
                [cd_out_0[x], cd_out_1[x], cd_out_2[x], cd_out_3[x], cd_out_4[x],
                 cd_out_5[x], cd_out_6[x], cd_out_7[x]])
    ...
    # Test model with pfb using dsim
    # ------------------------------
    def dsim_pol0_pfb(self, arm_mode, trig_mode, valid_mode, delay, read_length):
        ...
        print "Grabbing snap_reorda"
        reorda = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reorda_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']

        print "Grabbing snap_reordb"
        reordb = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reordb_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']


        print "Grabbing snap_reord_datain"
        reord_datain0 = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_din_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']
        #reord_datain1 = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_datain1_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']


        print "Grabbing snap_reord_dataout"
        reord_dataout0 = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_reord_dout_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']
        #reord_dataout1 = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_snap_reord_dataout1_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']

        #reord_fifo = self.f.snapshots.cd_compensation0_cd_hmc_hmc_delay_snap_fifo_ss.read(arm=False, man_trig=trig_mode, man_valid=valid_mode)['data']
        ...
        reord_datain_00 = reord_datain0['d0']
        reord_datain_01 = reord_datain0['d1']
        reord_datain_02 = reord_datain0['d2']
        reord_datain_03 = reord_datain0['d3']
        reord_datain_04 = reord_datain0['d4']
        reord_datain_05 = reord_datain0['d5']
        reord_datain_06 = reord_datain0['d6']
        reord_datain_07 = reord_datain0['d7']
        reord_addra_0 = reord_datain0['addra']
        reord_ena_0 = reord_datain0['ena']

        #reord_datain_10 = reord_datain1['d0']
        #reord_datain_11 = reord_datain1['d1']
        #reord_datain_12 = reord_datain1['d2']
        #reord_datain_13 = reord_datain1['d3']
        #reord_datain_14 = reord_datain1['d4']
        #reord_datain_15 = reord_datain1['d5']
        #reord_datain_16 = reord_datain1['d6']
        #reord_datain_17 = reord_datain1['d7']
        #reord_addra_1 = reord_datain1['addra']
        #reord_ena_1 = reord_datain1['ena']

        reord_dataout_00 = reord_dataout0['d0']
        reord_dataout_01 = reord_dataout0['d1']
        reord_dataout_02 = reord_dataout0['d2']
        reord_dataout_03 = reord_dataout0['d3']
        reord_dataout_04 = reord_dataout0['d4']
        reord_dataout_05 = reord_dataout0['d5']
        reord_dataout_06 = reord_dataout0['d6']
        reord_dataout_07 = reord_dataout0['d7']


        #reord_dataout_10 = reord_dataout1['d0']
        #reord_dataout_11 = reord_dataout1['d1']
        #reord_dataout_12 = reord_dataout1['d2']
        #reord_dataout_13 = reord_dataout1['d3']
        #reord_dataout_14 = reord_dataout1['d4']
        #reord_dataout_15 = reord_dataout1['d5']
        #reord_dataout_16 = reord_dataout1['d6']
        #reord_dataout_17 = reord_dataout1['d7']

        #reord_fifo_0 = reord_fifo['d0']
        #reord_fifo_1 = reord_fifo['d1']
        #reord_fifo_2 = reord_fifo['d2']
        #reord_fifo_3 = reord_fifo['d3']
        #reord_fifo_4 = reord_fifo['d4']
        #reord_fifo_5 = reord_fifo['d5']
        #reord_fifo_6 = reord_fifo['d6']
        #reord_fifo_7 = reord_fifo['d7']
        #reord_fifo_dv = reord_fifo['dv']
        #reord_fifo_sync = reord_fifo['sync']
        ...
        print ''
        print 'Pack the Reorder input'
        print '----------------------'
        reord_din0 = []
        reord_din1 = []

        for x in range(0, len(reord_datain_00)):
            reord_din0.extend(
                [reord_datain_00[x], reord_datain_01[x], reord_datain_02[x], reord_datain_03[x], reord_datain_04[x],
                 reord_datain_05[x], reord_datain_06[x], reord_datain_07[x]])

        #for x in range(0, len(reord_datain_10)):
        #    reord_din1.extend(
        ...
        for x in range(0, len(reord_dataout_00)):
            dout0.extend([reord_dataout_00[x], reord_dataout_01[x], reord_dataout_02[x], reord_dataout_03[x], reord_dataout_04[x], reord_dataout_05[x], reord_dataout_06[x], reord_dataout_07[x]])

        #for x in range(0, len(reord_dataout_10)):
        #    dout1.extend([reord_dataout_10[x], reord_dataout_11[x], reord_dataout_12[x], reord_dataout_13[x], reord_dataout_14[x], reord_dataout_15[x], reord_dataout_16[x], reord_dataout_17[x]])
        ...
        print ''
        print 'Pack the FIFO output correctly'
        print '-----------------------------'

        fifo = []

        #for x in range(0, len(reord_fifo_0)):
        #    fifo.extend([reord_fifo_0[x], reord_fifo_1[x], reord_fifo_2[x], reord_fifo_3[x], reord_fifo_4[x], reord_fifo_5[x],
        #                      reord_fifo_6[x], reord_fifo_7[x]])
        ...
        plt.plot(reord_int_reord_full_reg2)
        plt.subplot(613)
        plt.plot(reord_int_reord_out_lower)
        plt.subplot(614)
        plt.plot(reord_int_rst_reg)
        plt.subplot(615)
        plt.plot(reord_int_reord_cnt_en1)
        plt.subplot(616)
        plt.plot(reord_int_reord_cnt_en2)
        ...
        plt.clf()
        plt.subplot(411)
        plt.plot(reord_int_rd_addr_en)
        plt.subplot(412)
        plt.plot(reord_int_bram_rd_en)
        plt.subplot(413)
        plt.plot(reord_int_bram_rd_addr)
        plt.subplot(414)
        plt.plot(reord_int_bram_rd_addr_full)
        '''
        ...
        plt.plot(reord_din1)
        plt.subplot(413)
        plt.plot(reord_addra_0)
        plt.subplot(414)
        plt.plot(reord_ena_0)
        '''
    ...
    # Test model with no pfb using dsim
    # ---------------------------------
    def dsim_pol0_no_pfb(self, arm_mode, trig_mode, valid_mode, delay, read_length):
        ...
        # Set new trig time
        self.f.registers.tl_cd0_control.write(load_time_msw=local_time_msw['data']['timestamp_msw'] + 1)

        print "Time load time is (msw) is %s" % self.f.registers.tl_cd0_control.read()
        print ''

        self.f.registers.tl_cd0_control.write(arm=1, load_immediate=1)
        #self.f.registers.tl_cd0_control.write(arm=0, load_immediate=0)
        # --------------------------------------------------------------------------------------------------------------
        ...
        # Set the Snap trig source
        self.f.registers.control.write(adc_snap_trig_select=2)
        ...
        # Set new trig time
        #self.f.registers.trig_time_msw.write(msw=local_time_msw['data']['timestamp_msw'] + 1)
        ...
        print 'Arming Snapblocks'
        print "-----------------"
        self.f.snapshots.snap_adc0_ss.arm(man_trig=trig_mode, man_valid=valid_mode)
        self.f.snapshots.snap_adc1_ss.arm(man_trig=trig_mode, man_valid=valid_mode)
        ...
        print "Grabbing snap_adc0"
        data_in0 = self.f.snapshots.snap_adc0_ss.read(arm=False)['data']

        print "Grabbing snap_adc1"
        data_in1 = self.f.snapshots.snap_adc1_ss.read(arm=False)['data']

        print "Grabbing hmc_out"
        hmc_out = self.f.snapshots.snap_adc1_ss.read(arm=False)['data']
        ...
        reord_int_p1 = \
        self.f.snapshots.cd_compensation1_cd_hmc_hmc_delay_Reorder_cntrl_reord_int_ss.read(arm=False)['data']

        print "Grabbing cd_out"
        cd_out = self.f.snapshots.cd_out_ss.read(arm=False)['data']

        cd_out1 = self.f.snapshots.cd_out1_ss.read(arm=False)['data']
        ...
        reord_dataout_08 = reord_dataout1['d0']
        reord_dataout_09 = reord_dataout1['d1']
        reord_dataout_10 = reord_dataout1['d2']
        reord_dataout_11 = reord_dataout1['d3']
        reord_dataout_12 = reord_dataout1['d4']
        ...
        reord_int_bram_rd_addr_full = reord_int_p1['bram_rd_addr_full']
        reord_int_bram_rd_addr = reord_int_p1['bram_rd_addr']
        reord_int_rst = reord_int_p1['rst']
        reord_int_rst_reg = reord_int_p1['reg_rst']
        reord_int_wr_en = reord_int_p1['wr_en']
        reord_int_wr_cnt = reord_int_p1['wr_cnt']
        reord_int_reord_p0_ph1_rdy_s2 = reord_int_p1['p0_ph1_rdy']
        reord_int_reord_p0_ph2_rdy_s2 = reord_int_p1['p0_ph2_rdy']
        reord_int_reord_p1_ph1_rdy_s2 = reord_int_p1['p1_ph1_rdy']
        reord_int_reord_p1_ph2_rdy_s2 = reord_int_p1['p1_ph2_rdy']

        hmc_out_00 = hmc_out['d0']
        hmc_out_01 = hmc_out['d1']
        hmc_out_02 = hmc_out['d2']
        hmc_out_03 = hmc_out['d3']
        hmc_out_04 = hmc_out['d4']
        hmc_out_05 = hmc_out['d5']
        hmc_out_06 = hmc_out['d6']
        hmc_out_07 = hmc_out['d7']
        ...
        for x in range(0, len(reord_dataout_00)):
            dout0.extend([reord_dataout_00[x], reord_dataout_01[x], reord_dataout_02[x], reord_dataout_03[x],
                          reord_dataout_04[x], reord_dataout_05[x], reord_dataout_06[x], reord_dataout_07[x]])
        ...
        for x in range(0, len(hmc_out_00)):
            hmc_out0.extend([hmc_out_00[x], hmc_out_01[x], hmc_out_02[x], hmc_out_03[x],
                          hmc_out_04[x], hmc_out_05[x], hmc_out_06[x], hmc_out_07[x]])
